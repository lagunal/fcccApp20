...
const PLAYLIST = [
  new PlaylistItem(
    "Dios es soberano",
    "gs://rn-fccc.appspot.com/predica1.mp3",
    false
  ),
  new PlaylistItem(
    "Big Buck Bunny",
  ...
  new PlaylistItem(
    ...
    require('../assets/media/predica1.mp3'),
    false
  )
];
...
const ICON_PLAY_BUTTON = new Icon(
  require("../assets/images2/play_button.png"),
  34,
  51
);
const ICON_PAUSE_BUTTON = new Icon(
  require("../assets/images2/pause_button.png"),
  34,
  51
);
const ICON_STOP_BUTTON = new Icon(
  require("../assets/images2/stop_button.png"),
  22,
  22
);
const ICON_FORWARD_BUTTON = new Icon(
  require("../assets/images2/forward_button.png"),
  33,
  25
);
const ICON_BACK_BUTTON = new Icon(
  require("../assets/images2/back_button.png"),
  33,
  25
);

const ICON_LOOP_ALL_BUTTON = new Icon(
  require("../assets/images2/loop_all_button.png"),
  77,
  35
);
const ICON_LOOP_ONE_BUTTON = new Icon(
  require("../assets/images2/loop_one_button.png"),
  77,
  35
);

const ICON_MUTED_BUTTON = new Icon(
  require("../assets/images2/muted_button.png"),
  67,
  58
);
const ICON_UNMUTED_BUTTON = new Icon(
  require("../assets/images2/unmuted_button.png"),
  67,
  58
);

const ICON_TRACK_1 = new Icon(require("../assets/images2/track_1.png"), 166, 5);
const ICON_THUMB_1 = new Icon(require("../assets/images2/thumb_1.png"), 18, 19);
const ICON_THUMB_2 = new Icon(require("../assets/images2/thumb_2.png"), 15, 19);
...
export default class App extends React.Component {
  ...
  async _loadNewPlaybackInstance(playing) {
    ...
    //const source = require('../assets/media/predica1.mp3');
    const source = { uri: this.mediaUri };
    const initialStatus = {
      shouldPlay: playing,
